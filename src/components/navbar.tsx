...
const Navbar = () => {
  ...
  return (
    <div className="bg-whtie sticky z-50 top-0 inset-x-0 h-16 ">
      <header className="relative bg-whtie">
        <MaxWidthWrapper>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  {user ? null : <div className="flex lg:ml-6"><span aria-hidden="true" className="h-6 w-px bg-gray-200"></span></div>}
