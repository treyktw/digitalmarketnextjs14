...
const perks = [
  ...
  },
  {
    name: "For the Planet",
    Icon: Leaf,
    description: "Weve pladged 1% of sales to the preservation and restoration of the natural environmnet"
  }
]
    ...
    <MaxWidthWrapper>
      <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl ">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">Welcome to DigitalTurtle. Every assets on our platform is verified by our team to ensure our highest quality standards</p>
            ...
            {perks.map((perk) => (
              <div key={perk.name} className="text-center md:flex md:items-center md:text-left lg:block lg:text-center">
                ...
                <div className="mt-6 md:ml-4 md:mt-0 lg:ml-0  lg:mt-6">
                  <h3 className="text-based font-medium text-gray-900">{perk.name}</h3>
